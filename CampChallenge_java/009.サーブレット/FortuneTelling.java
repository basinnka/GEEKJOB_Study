...
public class FortuneTelling extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //次の1行は、ブラウザに返すWebページの文字コードを指定しています。デフォルトでは、UTF-8になっていますね。
        response.setContentType("text/html;charset=UTF-8");
        //これは、Webページを出力するためのクラスを生成しています。JSPでout.printとやっていましたがサーブレットで使うoutはここで生成します。
        try (PrintWriter out = response.getWriter()) {
            /*TODO output your page here. You may use following sample code. */
            //tryの中のコメントにもありますが、ここでページの出力を行っています。
